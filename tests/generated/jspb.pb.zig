...
pub const TestMessageWithOneof = struct {
    ...
    pub const _desc_table = .{
        ...
        .partial_oneof = fd(null, .{ .OneOf = std.meta.Child(@FieldType(@This(), "partial_oneof")) }),
        .recursive_oneof = fd(null, .{ .OneOf = std.meta.Child(@FieldType(@This(), "recursive_oneof")) }),
        .default_oneof_a = fd(null, .{ .OneOf = std.meta.Child(@FieldType(@This(), "default_oneof_a")) }),
        .default_oneof_b = fd(null, .{ .OneOf = std.meta.Child(@FieldType(@This(), "default_oneof_b")) }),
    };
