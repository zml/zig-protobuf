...
pub const TestAllTypes = struct {
    ...
    pub const _desc_table = .{
        ...
        .oneof_field = fd(null, .{ .OneOf = std.meta.Child(@FieldType(@This(), "oneof_field")) }),
    };
...
pub const TestOneof = struct {
    ...
    pub const _desc_table = .{
        .foo = fd(null, .{ .OneOf = std.meta.Child(@FieldType(@This(), "foo")) }),
    };
...
pub const TestOneof2 = struct {
    ...
    pub const _desc_table = .{
        ...
        .foo = fd(null, .{ .OneOf = std.meta.Child(@FieldType(@This(), "foo")) }),
        .bar = fd(null, .{ .OneOf = std.meta.Child(@FieldType(@This(), "bar")) }),
    };
